...
```json
{
  "PermissionRequest": "node ~/.codex/plugins/cache/socket/speak-swiftly/6.0.0/hooks/permission-request-log.mjs",
  "Stop": "node ~/.codex/plugins/cache/socket/speak-swiftly/6.0.0/hooks/stop-tts.mjs"
}
```
